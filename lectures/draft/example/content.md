# 用 Agent Skill 打造可重複使用的講義網站
> 從一次性的 Vibe Coding 成果出發，把講義網站整理成可長期維護、可重複生成、可部署分享的 Agent Skill 工作流。

[summary]
- 工具主軸 **Codex + Vibe Coding** | 透過終端機與編輯器外掛示範兩種操作方式
- 核心方法 **模板化講義網站** | 將 HTML、CSS、JS、Markdown 語法與建置流程封裝成 Skill
- 實作成果 **README 轉網頁** | 讓講稿變成可瀏覽、可匯出 PDF、可部署的課程頁面
- 重要提醒 **細節來自專業** | AI 能加速生成，但模板設計與工作流治理決定成果品質
[/summary]
嗨！大家好，我是鼎淵
